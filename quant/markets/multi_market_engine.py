...
class MultiMarketEngine:
    ...
    def predict_all(
        self, upcoming_matches: list[dict], odds_map: dict | None = None
    ) -> list[dict]:
        """
        ...
        for fixture in upcoming_matches:
            ...
            try:
                ...
                logger.warning(
                    "MultiMarketEngine: prediction failed for %s vs %s: %s",
                    home,
                    away,
                    exc,
                )
